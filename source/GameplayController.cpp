...
bool GameplayController::initLevel(int selected_level) {
    ...
    std::vector<string> texture_strings_level_8 = { "down_blocked_1", "planter-brown1", "fully_blocked_1", "fully_blocked_2", "fully_blocked_3", "fully_blocked_4", "left_blocked_1", "day6Building", "level6Window1", "level6Window2" };
