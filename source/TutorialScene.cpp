//  GameScene.cpp
//
//  This is the primary class file for running the tutorial game.
//
 ...
 */
bool TutorialScene::init(const std::shared_ptr<cugl::AssetManager>& assets, int fps) {
 ...
 */
void TutorialScene::render(const std::shared_ptr<cugl::SpriteBatch>& batch) {
