...
LOCAL_C_INCLUDES += $(CUGL_PATH)/$(SDL2_OFFSET)/include
LOCAL_C_INCLUDES += $(CUGL_PATH)/$(ATK_OFFSET)/include
LOCAL_C_INCLUDES += $(CUGL_PATH)/$(APP_OFFSET)/include
LOCAL_C_INCLUDES += $(CUGL_PATH)/$(IMG_OFFSET)
LOCAL_C_INCLUDES += $(CUGL_PATH)/$(TTF_OFFSET)
